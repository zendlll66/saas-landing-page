...
const YourDataSection = () => {
    return (
        <div className='py-[100px] px-4 sm:px-8 md:px-16 lg:px-[120px] flex flex-col lg:flex-row items-center gap-10'>
            
            {/* Text Section */}
            <div className='w-full lg:w-1/2 flex flex-col justify-center'>
                <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold text-black mb-6 leading-tight text-center lg:text-left'>
                    100% your data
                </h1>
