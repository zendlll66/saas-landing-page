...
const ProjectSection = () => {
    ...
    return (
        <div id='products' className='scroll-mt-[100px] bg-white w-full relative px-5 md:px-[120px]'>
            {/* background Element */}
            <Image
            ...
            <div className='flex flex-col lg:flex-row my-[80px] lg:my-[140px] gap-y-10 lg:gap-y-0 lg:space-x-[60px] relative z-10'>
                <div className='w-full lg:w-1/2 space-y-[40px] text-center lg:text-left'>
                    <div data-aos="fade-up" className='space-y-[24px] '>
                        <h1   className='text-4xl md:text-5xl lg:text-6xl font-bold text-black leading-tight animate-fadeIn '>
                            Project Management
                        </h1>
