    ...
    <div className="bg-[#6D64FE] relative text-white w-full flex flex-col justify-center items-center text-center px-4 sm:px-8 md:px-16 lg:px-[140px] py-[100px] overflow-hidden">
      ...
      <div className="relative z-10 w-full flex flex-col justify-center items-center">
        <div className="flex flex-col items-center max-w-4xl">
          <h1 data-aos="fade-up" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
            Your work, everywhere you are
          </h1>
          <p data-aos="fade-up" className="text-sm sm:text-base md:text-lg text-gray-300 mt-4 leading-relaxed">
