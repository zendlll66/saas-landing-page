...
const ExtesionSection = () => {
    ...
    return (
        <div id ={"solutions"} className='bg-[#6D64FE] flex flex-col md:flex-row items-center justify-center py-10 md:py-[120px] px-5 md:px-[120px] gap-10'>

            <div className='w-full md:w-1/2 flex flex-col justify-center text-center md:text-left'>
                <h1 data-aos="fade-up" className='text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight'>
                    Use as Extension
                </h1>
                <p data-aos="fade-up" className='text-base md:text-lg lg:text-xl text-white opacity-80 mb-8 max-w-lg mx-auto md:mx-0'>
            ...
            <div className='w-full md:w-1/2 flex justify-center'>
                <div data-aos="fade-up" className='w-full max-w-sm md:max-w-md lg:max-w-lg'>
                    <Image
